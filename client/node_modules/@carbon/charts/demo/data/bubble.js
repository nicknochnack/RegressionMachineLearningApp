...
export var bubbleDoubleLinearData = [
...
export var bubbleDoubleLinearOptions = {
    title: "Bubble (linear)",
    axes: {
        bottom: {
...
export var bubbleDiscreteOptions = {
...
export var bubbleTimeSeriesData = lineTimeSeriesData.map(function (datum) {
    return Object.assign(datum, {
        surplus: 50000 * Math.random() * ((datum["value"] || 1) / 2)
    });
});
export var bubbleTimeSeriesOptions = {
...
// bubble - empty state
export var bubbleEmptyStateData = [];
export var bubbleEmptyStateOptions = {
...
// bubble - skeleton
export var bubbleSkeletonData = [];
export var bubbleSkeletonOptions = {
...
//# sourceMappingURL=../../../demo/data/bubble.js.map