...
<ul data-progress data-progress-current class="bx--progress ">
    ...
    <li class="bx--progress-step bx--progress-step--current "  >
      ...
      <p tabindex="0" class="bx--progress-label" aria-describedby="label-tooltiponsdbf9v3n">
            Overflow Ex.1
      </p>
      <div id="label-tooltiponsdbf9v3n" role="tooltip" data-floating-menu-direction="bottom" class="bx--tooltip" data-avoid-focus-on-open>
        <span class="bx--tooltip__caret"></span>
    ...
    <li class="bx--progress-step bx--progress-step--incomplete "  >
      ...
      <p tabindex="0" class="bx--progress-label" aria-describedby="label-tooltipkuxlvupsr9">
            Overflow Ex. 2 Multi Line
      </p>
      <div id="label-tooltipkuxlvupsr9" role="tooltip" data-floating-menu-direction="bottom" class="bx--tooltip" data-avoid-focus-on-open>
        <span class="bx--tooltip__caret"></span>
