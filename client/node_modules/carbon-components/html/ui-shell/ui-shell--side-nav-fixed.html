...
<header class="bx--header" role="banner" aria-label="IBM Platform Name" data-header>
  ...
  <button class="bx--header__menu-trigger bx--header__action" aria-label="Open menu" title="Open menu"
    ...
    data-navigation-menu-target="#navigation-menu-2mz9ic9sv58">
  ...
  <div class="bx--header__global">
    <button class="bx--header__menu-trigger bx--header__action" aria-label="Action 1"
      ...
      data-navigation-menu-panel-label-collapse="Close menu" data-product-switcher-target="#switcher-wzugyn7gupl">
...
<aside class="bx--panel--overlay" id="switcher-wzugyn7gupl" data-product-switcher>
...
<div class="bx--navigation" id="navigation-menu-2mz9ic9sv58"
