...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-8v0iu8lctrd">Show
  modal</button>

<div data-modal id="modal-8v0iu8lctrd" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-8v0iu8lctrd-label" aria-describedby="modal-8v0iu8lctrd-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-8v0iu8lctrd-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-8v0iu8lctrd-heading">Modal heading</p>
