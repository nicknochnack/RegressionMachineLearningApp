...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-vlrtyak9mhr">Show
  modal</button>

<div data-modal id="modal-vlrtyak9mhr" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-vlrtyak9mhr-label" aria-describedby="modal-vlrtyak9mhr-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-vlrtyak9mhr-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-vlrtyak9mhr-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
