...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-tbgkbr9x9p">Show
  modal</button>

<div data-modal id="modal-tbgkbr9x9p" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-tbgkbr9x9p-label" aria-describedby="modal-tbgkbr9x9p-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-tbgkbr9x9p-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-tbgkbr9x9p-heading">Modal heading</p>
