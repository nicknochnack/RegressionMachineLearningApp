...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-nog3impkcn">Show
  modal</button>

<div data-modal id="modal-nog3impkcn" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-nog3impkcn-label" aria-describedby="modal-nog3impkcn-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-nog3impkcn-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-nog3impkcn-heading">Modal heading</p>
