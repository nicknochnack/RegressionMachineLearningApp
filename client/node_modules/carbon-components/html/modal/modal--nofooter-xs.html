...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-vcy82owr6g">Show
  modal</button>

<div data-modal id="modal-vcy82owr6g" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-vcy82owr6g-label" aria-describedby="modal-vcy82owr6g-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-vcy82owr6g-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-vcy82owr6g-heading">Modal heading</p>
