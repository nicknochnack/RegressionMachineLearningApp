...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-4zlh64r0uoy">Show
  modal</button>

<div data-modal id="modal-4zlh64r0uoy" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-4zlh64r0uoy-label" aria-describedby="modal-4zlh64r0uoy-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-4zlh64r0uoy-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-4zlh64r0uoy-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
