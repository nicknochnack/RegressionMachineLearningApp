...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-o1z3y61vrh">Show
  modal</button>

<div data-modal id="modal-o1z3y61vrh" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-o1z3y61vrh-label" aria-describedby="modal-o1z3y61vrh-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-o1z3y61vrh-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-o1z3y61vrh-heading">Modal heading</p>
