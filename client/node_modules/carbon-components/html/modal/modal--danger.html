...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-wu0n0sx258j">Show
  modal</button>

<div data-modal id="modal-wu0n0sx258j" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-wu0n0sx258j-label" aria-describedby="modal-wu0n0sx258j-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-wu0n0sx258j-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-wu0n0sx258j-heading">Modal heading</p>
