...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-zmns6h86rct">Show
  modal</button>

<div data-modal id="modal-zmns6h86rct" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-zmns6h86rct-label" aria-describedby="modal-zmns6h86rct-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-zmns6h86rct-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-zmns6h86rct-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
