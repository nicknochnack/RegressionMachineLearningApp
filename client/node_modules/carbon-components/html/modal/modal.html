...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-gnuy63bi2lt">Show
  modal</button>

<div data-modal id="modal-gnuy63bi2lt" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-gnuy63bi2lt-label" aria-describedby="modal-gnuy63bi2lt-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-gnuy63bi2lt-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-gnuy63bi2lt-heading">Modal heading</p>
