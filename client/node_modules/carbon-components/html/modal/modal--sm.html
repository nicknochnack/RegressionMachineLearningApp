...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-rgvd638g6p8">Show
  modal</button>

<div data-modal id="modal-rgvd638g6p8" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-rgvd638g6p8-label" aria-describedby="modal-rgvd638g6p8-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-rgvd638g6p8-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-rgvd638g6p8-heading">Modal heading</p>
