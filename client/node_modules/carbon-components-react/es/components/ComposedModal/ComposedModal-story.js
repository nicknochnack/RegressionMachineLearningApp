...
storiesOf('ComposedModal', module).addDecorator(withKnobs).add('Using Header / Footer Props', function () {
  ...
  }, "Please see ModalWrapper for more examples and demo of the functionality."), hasScrollingContent && scrollingContent), /*#__PURE__*/React.createElement(ModalFooter, props.modalFooter()));
}, {
  info: {
  ...
  return /*#__PURE__*/React.createElement(ComposedModal, _extends({}, rest, {
    ...
    "aria-label": hasScrollingContent ? 'Modal content' : undefined
  }), /*#__PURE__*/React.createElement("p", null, "Please see ModalWrapper for more examples and demo of the functionality."), hasScrollingContent && scrollingContent), /*#__PURE__*/React.createElement(ModalFooter, null, /*#__PURE__*/React.createElement(Button, {
    kind: "secondary"
  ...
  var ComposedModalExample = /*#__PURE__*/function (_React$Component) {
    _inherits(ComposedModalExample, _React$Component);

    var _super = _createSuper(ComposedModalExample);
    ...
    _createClass(ComposedModalExample, [{
      ...
      value: function render() {
        ...
        }, "Launch composed modal"), /*#__PURE__*/React.createElement(ComposedModal, _extends({}, rest, {
          open: open,
          size: size || undefined,
  ...
  return /*#__PURE__*/React.createElement(ComposedModalExample, null);
}, {
  info: {
