...
describe('<ModalHeader />', function () {
  describe('Renders as expected', function () {
    var titleWrapper = shallow( /*#__PURE__*/React.createElement(ModalHeader, {
      title: "Something"
    }));
    var labelWrapper = shallow( /*#__PURE__*/React.createElement(ModalHeader, {
      label: "Something"
    }));
...
describe('<ModalBody />', function () {
  describe('Renders as expected', function () {
    var wrapper = shallow( /*#__PURE__*/React.createElement(ModalBody, {
...
describe('<ModalFooter />', function () {
  ...
  describe('Should render buttons only if appropriate prop passed in in', function () {
    ...
    var secondaryWrapper = shallow( /*#__PURE__*/React.createElement(ModalFooter, {
...
describe('<ComposedModal />', function () {
  ...
  it('avoids change the open state upon setting props, unless there the value actually changes', function () {
    var wrapper = shallow( /*#__PURE__*/React.createElement(ComposedModal, null));
    wrapper.setProps({
      open: true
    });
    wrapper.setState({
