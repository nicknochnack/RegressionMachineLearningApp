...
storiesOf('DatePicker', module).addDecorator(withKnobs).add('simple', function () {
  return /*#__PURE__*/React.createElement(DatePicker, _extends({}, props.datePicker(), {
    short: boolean('Use shorter width (short in <DatePicker>)', false),
    datePickerType: "simple"
  }), /*#__PURE__*/React.createElement(DatePickerInput, props.datePickerInput()));
}, {
  info: {
  ...
  return /*#__PURE__*/React.createElement(WithState, {
    ...
    }, /*#__PURE__*/React.createElement(DatePickerInput, _extends({}, props.datePickerInput(), {
      id: "date-picker-input-id"
