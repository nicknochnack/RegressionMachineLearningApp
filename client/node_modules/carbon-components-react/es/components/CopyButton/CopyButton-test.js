...
describe('CopyButton', function () {
  ...
  describe('Renders button props as expected', function () {
    var wrapper;
    beforeEach(function () {
      wrapper = mount( /*#__PURE__*/React.createElement(CopyButton, null));
    });
    ...
    it('Should have a default feedback timeout', function () {
      var timeoutWrapper = mount( /*#__PURE__*/React.createElement(CopyButton, null));
    ...
    it('Should be able to set the timeout for displaying feedback', function () {
      var timeoutWrapper = mount( /*#__PURE__*/React.createElement(CopyButton, {
    ...
    it('Should be able to specify the feedback message', function () {
      var feedbackWrapper = mount( /*#__PURE__*/React.createElement(CopyButton, {
        feedback: "Copied!"
      }));
  ...
  describe('Triggers appropriate events', function () {
    it('should call the click handler', function () {
      var onClick = jest.fn();
      var clickWrapper = mount( /*#__PURE__*/React.createElement(CopyButton, {
        onClick: onClick
      }));
