...
describe('Pagination', function () {
  describe('renders as expected', function () {
    var pagination = mount( /*#__PURE__*/React.createElement(Pagination, {
      className: "extra-class",
      pageSizes: [5, 10],
      totalItems: 50
    }));
    describe('icons', function () {
      var iconTypes = [CaretLeft16, CaretRight16];
    ...
    describe('pagination size container', function () {
      ...
      describe('pagination size container when total pages unknown', function () {
        var pager = mount( /*#__PURE__*/React.createElement(Pagination, {
          pageSizes: [5, 10],
          pagesUnknown: true
        }));
    ...
    describe('pagination paging container', function () {
      ...
      it('should disable forward navigation for the last page', function () {
        var smallPage = shallow( /*#__PURE__*/React.createElement(Pagination, {
          className: "extra-class",
          pageSizes: [100],
          totalItems: 50
        }));
      ...
      describe('pagination paging container when total pages unknown', function () {
        ...
        it('should hide text input if disabled', function () {
          var noTextInput = shallow( /*#__PURE__*/React.createElement(Pagination, {
            pageSizes: [100],
            pagesUnknown: true,
            disabled: true
          }));
        ...
        it('should append `pagination__button--no-index` class if input is disabled', function () {
          var pagination = shallow( /*#__PURE__*/React.createElement(Pagination, {
            page: 2,
            pageSizes: [100],
            pagesUnknown: true,
            disabled: true
