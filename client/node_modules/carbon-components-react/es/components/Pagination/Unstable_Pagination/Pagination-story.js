...
storiesOf('UNSTABLE Pagination', module).addDecorator(withKnobs).addDecorator(function (story) {
  ...
  return /*#__PURE__*/React.createElement(Unstable_Pagination, _extends({}, props(), {
    totalItems: 350,
