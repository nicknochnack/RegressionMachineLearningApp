...
storiesOf('ToggleSmall', module).addDecorator(withKnobs).add('toggled', function () {
  return /*#__PURE__*/React.createElement(ToggleSmall, _extends({
    defaultToggled: true
  }, toggleProps(), {
    className: "some-class",
    id: "toggle-1"
  ...
  return /*#__PURE__*/React.createElement(ToggleSmall, _extends({}, toggleProps(), {
    className: "some-class",
    id: "toggle-1"
  }));
}, {
  ...
  return /*#__PURE__*/React.createElement(ToggleSmallSkeleton, a11yprops());
}, {
  info: {
