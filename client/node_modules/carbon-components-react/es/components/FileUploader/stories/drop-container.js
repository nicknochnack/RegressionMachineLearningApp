...
var ExampleDropContainerApp = function ExampleDropContainerApp(props) {
  ...
  return /*#__PURE__*/React.createElement(FormItem, null, /*#__PURE__*/React.createElement("strong", {
    className: "".concat(prefix, "--file--label")
  }, "Account photo"), /*#__PURE__*/React.createElement("p", {
    className: "".concat(prefix, "--label-description")
  }, "Only .jpg and .png files. 500kb max file size"), /*#__PURE__*/React.createElement(FileUploaderDropContainer, _extends({}, props, {
    ...
    var uuid = _ref5.uuid,
        ...
        rest = _objectWithoutProperties(_ref5, ["uuid", "name", "filesize", "status", "iconDescription", "invalid"]);
