...
describe('TooltipIcon', function () {
  ...
  beforeEach(function () {
    mockProps = {
      direction: 'bottom',
      children: /*#__PURE__*/React.createElement("svg", null),
      className: 'custom-class',
      tooltipText: 'tooltip text'
    };
  });
  it('should render', function () {
    var wrapper = mount( /*#__PURE__*/React.createElement(TooltipIcon, mockProps));
  ...
  it('should allow the user to specify the direction', function () {
    var wrapper = mount( /*#__PURE__*/React.createElement(TooltipIcon, _extends({}, mockProps, {
      direction: "top"
    })));
    expect(wrapper).toMatchSnapshot();
  });
