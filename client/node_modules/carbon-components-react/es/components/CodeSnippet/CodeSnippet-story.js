...
storiesOf('CodeSnippet', module).addDecorator(withKnobs).add('inline', function () {
  ...
  }, props.inline().light && lightPropMessage, /*#__PURE__*/React.createElement(CodeSnippet, _extends({
    type: "inline"
  }, props.inline()), 'node -v'));
}, {
  info: {
  ...
  }, props.single().light && lightPropMessage, /*#__PURE__*/React.createElement(CodeSnippet, _extends({
    type: "single"
  ...
  }, multilineProps.light && lightPropMessage, /*#__PURE__*/React.createElement(CodeSnippet, _extends({
    type: "multi"
  }, multilineProps), "@mixin grid-container {\n  width: 100%;\n  padding-right: padding(mobile);\n  padding-left: padding(mobile);\n\n  @include breakpoint(bp--xs--major) {\n    padding-right: padding(xs);\n    padding-left: padding(xs);\n  }\n}\n\n$z-indexes: (\n  modal : 9000,\n  overlay : 8000,\n  dropdown : 7000,\n  header : 6000,\n  footer : 5000,\n  hidden : - 1,\n  overflowHidden: - 1,\n  floating: 10000\n);"), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement(CodeSnippet, _extends({
    type: "multi"
  }, multilineProps), "@mixin grid-container {\n  width: 100%;\n  padding-right: padding(mobile);\n  padding-left: padding(mobile);\n\n  @include breakpoint(bp--xs--major) {\n    padding-right: padding(xs);\n  }\n}"));
}, {
  info: {
