...
describe('OverflowMenu', function () {
  describe('Renders as expected', function () {
    ...
    it('should apply a tabindex to the menu', function () {
      var defaultMenu = mount( /*#__PURE__*/React.createElement(OverflowMenu, null, /*#__PURE__*/React.createElement("div", null, "Child"))).childAt(0); // Enzyme doesn't seem to allow props() in a forwardRef-wrapped class component
