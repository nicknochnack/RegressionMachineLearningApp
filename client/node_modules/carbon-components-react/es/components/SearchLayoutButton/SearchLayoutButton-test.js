...
describe('SearchLayoutButton', function () {
  var wrapper = mount( /*#__PURE__*/React.createElement(SearchLayoutButton, {
    labelText: "testlabel"
  }));
  ...
  describe('icons', function () {
    ...
    it('should support specifying the layout via props', function () {
      var wrapperWithFormatProps = mount( /*#__PURE__*/React.createElement(SearchLayoutButton, {
        format: "grid"
      }));
    ...
    it('should avoid change the format upon setting props, unless there the value actually changes', function () {
      var wrapperWithFormatProps = shallow( /*#__PURE__*/React.createElement(SearchLayoutButton, null));
      wrapperWithFormatProps.setProps({
        format: 'grid'
      });
