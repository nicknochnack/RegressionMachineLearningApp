...
describe('NumberInput', function () {
  describe('should render as expected', function () {
    ...
    beforeEach(function () {
      ...
      wrapper = mount( /*#__PURE__*/React.createElement(NumberInput, mockProps));
      var iconTypes = [CaretDownGlyph, CaretUpGlyph];
    ...
    describe('input', function () {
      ...
      it('should apply aria-label based on the label', function () {
        var getInputRegion = function getInputRegion() {
        ...
        expect(getInputRegion().prop('aria-label')).toEqual(mockProps.ariaLabel);
      });
      ...
      describe('initial rendering', function () {
        var getWrapper = function getWrapper(min, max, value) {
          return mount( /*#__PURE__*/React.createElement(NumberInput, {
            min: min,
            max: max,
            value: value,
            id: "test",
        ...
        it('should allow updating the value with empty string and not be invalid', function () {
          // Enzyme doesn't seem to allow setState() in a forwardRef-wrapped class component
          wrapper.find('NumberInput').instance().setState({
            value: 50
          });
        ...
        it.skip('should avoid capping when non-number prop is given to value prop', function () {
          // Enzyme doesn't seem to allow setState() in a forwardRef-wrapped class component
          wrapper.find('NumberInput').instance().setState({
            value: 2
          });
  ...
  describe('events', function () {
    describe('disabled numberInput', function () {
      ...
      var wrapper = mount( /*#__PURE__*/React.createElement(NumberInput, {
        id: "test",
        onClick: onClick,
        onChange: onChange,
        disabled: true
    ...
    describe('enabled numberInput', function () {
      ...
      beforeEach(function () {
        onClick = jest.fn();
        onChange = jest.fn();
        wrapper = mount( /*#__PURE__*/React.createElement(NumberInput, {
          id: "test",
          onClick: onClick,
          onChange: onChange,
          min: 0,
...
describe('NumberInputSkeleton', function () {
  describe('Renders as expected', function () {
    var wrapper = shallow( /*#__PURE__*/React.createElement(NumberInputSkeleton, null));
