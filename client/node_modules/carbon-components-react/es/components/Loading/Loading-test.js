...
describe('Loading', function () {
  ...
  describe('automated accessibility testing', function () {
    ...
    it('should have no DAP violations', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return expect(container).toHaveNoDAPViolations('Loading');
