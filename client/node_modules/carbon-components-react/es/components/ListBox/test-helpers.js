...
export var findListBoxNode = function findListBoxNode(wrapper) {
...
export var findComboboxNode = function findComboboxNode(wrapper) {
  return wrapper.find(".".concat(prefix, "--list-box[role=\"combobox\"]"));
};
export var findPopupNode = function findPopupNode(wrapper) {
