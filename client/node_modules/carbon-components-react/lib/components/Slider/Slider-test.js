...
describe('Slider', function () {
  ...
  var wrapper;
  beforeEach(function () {
    wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_Slider.default, {
      id: id,
  ...
  describe('Supporting label', function () {
    it('concatenates the value and the label by default', function () {
      var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_Slider.default, {
        min: 0,
        minLabel: "min",
        max: 100,
        maxLabel: "max",
...
describe('SliderSkeleton', function () {
  describe('Renders as expected', function () {
    var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_Slider2.default, null));
