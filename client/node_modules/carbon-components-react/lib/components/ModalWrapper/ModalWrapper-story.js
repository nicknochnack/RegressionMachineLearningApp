...
var iconMap = {
  ...
  AddFilled16: function AddFilled16(props) {
    return /*#__PURE__*/_react.default.createElement(_iconsReact.AddFilled16, _extends({
      className: "".concat(prefix, "--btn__icon")
    }, props));
  },
  // eslint-disable-next-line react/display-name
  Search16: function Search16(props) {
    return /*#__PURE__*/_react.default.createElement(_iconsReact.Search16, _extends({
      className: "".concat(prefix, "--btn__icon")
    }, props));
  }
};
...
(0, _react2.storiesOf)('ModalWrapper', module).addDecorator(_addonKnobs.withKnobs).add('transactional/passive modal', function () {
  return /*#__PURE__*/_react.default.createElement(_ModalWrapper.default, _extends({
  ...
  return /*#__PURE__*/_react.default.createElement(_ModalWrapper.default, _extends({
  ...
  }), /*#__PURE__*/_react.default.createElement("br", null), /*#__PURE__*/_react.default.createElement(_Select.default, {
    id: "select-1",
    labelText: "Select"
    ...
    value: "option-3",
    text: "Option 3"
  })), /*#__PURE__*/_react.default.createElement("br", null), /*#__PURE__*/_react.default.createElement(_RadioButtonGroup.default, {
