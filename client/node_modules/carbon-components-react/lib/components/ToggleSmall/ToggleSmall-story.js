...
(0, _react2.storiesOf)('ToggleSmall', module).addDecorator(_addonKnobs.withKnobs).add('toggled', function () {
  return /*#__PURE__*/_react.default.createElement(_ToggleSmall.default, _extends({
    defaultToggled: true
  }, toggleProps(), {
    className: "some-class",
    id: "toggle-1"
  ...
  return /*#__PURE__*/_react.default.createElement(_ToggleSmall.default, _extends({}, toggleProps(), {
    className: "some-class",
    id: "toggle-1"
  }));
}, {
  ...
  return /*#__PURE__*/_react.default.createElement(_ToggleSmall2.default, a11yprops());
}, {
  info: {
