...
describe('Tabs', function () {
  describe('renders as expected', function () {
    describe('navigation (<div>)', function () {
      var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_Tabs.default, {
        className: "extra-class"
      }, /*#__PURE__*/_react.default.createElement(_Tab.default, {
        label: "firstTab"
      }, "content1"), /*#__PURE__*/_react.default.createElement(_Tab.default, {
        label: "lastTab"
      }, "content2")));
      ...
      it('supports container variant', function () {
        expect((0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_Tabs.default, {
          className: "extra-class",
          type: "container"
        }, /*#__PURE__*/_react.default.createElement(_Tab.default, {
          label: "firstTab"
          ...
          label: "lastTab"
        }, "content2"))).find('div').first().hasClass("".concat(prefix, "--tabs--container"))).toBe(true);
      });
      it('has no selectionMode prop', function () {
        expect('selectionMode' in wrapper.find(".".concat(prefix, "--tabs")).props()).toBe(false);
      });
    });
    describe('Trigger (<div>)', function () {
      ...
      it('renders <Icon>', function () {
        expect(trigger.find(_iconsReact.ChevronDown16).length).toBe(1);
      });
    });
    describe('Children (<Tab>)', function () {
      var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_Tabs.default, null, /*#__PURE__*/_react.default.createElement(_Tab.default, {
        label: "firstTab"
      }, "content1"), /*#__PURE__*/_react.default.createElement(_Tab.default, {
        label: "lastTab"
      }, "content2")));
  ...
  describe('Children (<TabContent>)', function () {
    ...
    it('allows for custom classNames on <TabContent>', function () {
      var customTabContentClassWrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_Tabs.default, {
  ...
  describe('events', function () {
    describe('click', function () {
      var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_Tabs.default, null, /*#__PURE__*/_react.default.createElement(_Tab.default, {
        label: "firstTab",
        className: "firstTab"
      }, "content1"), /*#__PURE__*/_react.default.createElement(_Tab.default, {
        label: "lastTab",
    ...
    describe('keydown', function () {
      ...
      var firstTab;
      var lastTab;
      var anchorInFirstTab;
      var anchorInLastTab;
      var spyFocusAnchorInFirstTab;
      var spyFocusAnchorInLastTab;
      describe('state: selected', function () {
        beforeEach(function () {
          wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_Tabs.default, {
            selected: 0
          }, /*#__PURE__*/_react.default.createElement(_Tab.default, {
            label: "firstTab",
            className: "firstTab"
          }, "content"), /*#__PURE__*/_react.default.createElement(_Tab.default, {
            label: "lastTab",
            className: "lastTab"
          }, "content")));
      ...
      describe('ignore disabled child tab', function () {
        beforeEach(function () {
          wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_Tabs.default, null, /*#__PURE__*/_react.default.createElement(_Tab.default, {
            label: "firstTab",
            className: "firstTab"
          }, "content1"), /*#__PURE__*/_react.default.createElement(_Tab.default, {
            label: "middleTab",
            className: "middleTab",
            disabled: true
          }, "content2"), /*#__PURE__*/_react.default.createElement(_Tab.default, {
            label: "lastTab",
            className: "lastTab"
          }, "content3")));
          firstTab = wrapper.find('.firstTab').last();
  ...
  describe('Allow initial state to draw from props', function () {
    var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_Tabs.default, {
      selected: 1
    }, /*#__PURE__*/_react.default.createElement(_Tab.default, {
      label: "firstTab",
      className: "firstTab"
...
describe('TabsSkeleton', function () {
  describe('Renders as expected', function () {
    var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_Tabs2.default, null));
