...
(0, _react2.storiesOf)('InlineLoading', module).addDecorator(_addonKnobs.withKnobs).add('Inline loading', function () {
  return /*#__PURE__*/_react.default.createElement(_InlineLoading.default, props());
}, {
  info: {
  ...
  MockSubmission.__docgenInfo = _objectSpread(_objectSpread({}, _InlineLoading.default.__docgenInfo), {}, {
  ...
  return /*#__PURE__*/_react.default.createElement(MockSubmission, null, function (_ref2) {
    ...
    }, "Cancel"), isSubmitting || success ? /*#__PURE__*/_react.default.createElement(_InlineLoading.default, {
      style: {
        marginLeft: '1rem'
      },
      description: description,
