...
describe('Loading', function () {
  describe('Default state renders as expected', function () {
    var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_InlineLoading.default, {
  ...
  describe('Success state should render properly', function () {
    ...
    it('should call the onSuccess function after a delay', function (done) {
      (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_InlineLoading.default, {
        success: true,
