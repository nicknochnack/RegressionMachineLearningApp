...
describe('OverflowMenu', function () {
  describe('Renders as expected', function () {
    ...
    it('should apply a tabindex to the menu', function () {
      var defaultMenu = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_OverflowMenu.default, null, /*#__PURE__*/_react.default.createElement("div", null, "Child"))).childAt(0); // Enzyme doesn't seem to allow props() in a forwardRef-wrapped class component
