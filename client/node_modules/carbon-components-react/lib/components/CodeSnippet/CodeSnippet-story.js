...
var props = {
  inline: function inline() {
    return {
      ...
      feedback: (0, _addonKnobs.text)('Feedback text (feedback)', 'Copied to clipboard'),
...
(0, _react2.storiesOf)('CodeSnippet', module).addDecorator(_addonKnobs.withKnobs).add('inline', function () {
  return /*#__PURE__*/_react.default.createElement("div", {
    className: props.inline().light ? 'bx--tile' : ''
  }, props.inline().light && lightPropMessage, /*#__PURE__*/_react.default.createElement(_CodeSnippet.default, _extends({
    type: "inline"
  }, props.inline()), 'node -v'));
}, {
  info: {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: props.single().light ? 'bx--tile' : ''
  }, props.single().light && lightPropMessage, /*#__PURE__*/_react.default.createElement(_CodeSnippet.default, _extends({
    type: "single"
  ...
  }, multilineProps.light && lightPropMessage, /*#__PURE__*/_react.default.createElement(_CodeSnippet.default, _extends({
    type: "multi"
  }, multilineProps), "@mixin grid-container {\n  width: 100%;\n  padding-right: padding(mobile);\n  padding-left: padding(mobile);\n\n  @include breakpoint(bp--xs--major) {\n    padding-right: padding(xs);\n    padding-left: padding(xs);\n  }\n}\n\n$z-indexes: (\n  modal : 9000,\n  overlay : 8000,\n  dropdown : 7000,\n  header : 6000,\n  footer : 5000,\n  hidden : - 1,\n  overflowHidden: - 1,\n  floating: 10000\n);"), /*#__PURE__*/_react.default.createElement("br", null), /*#__PURE__*/_react.default.createElement(_CodeSnippet.default, _extends({
    type: "multi"
  }, multilineProps), "@mixin grid-container {\n  width: 100%;\n  padding-right: padding(mobile);\n  padding-left: padding(mobile);\n\n  @include breakpoint(bp--xs--major) {\n    padding-right: padding(xs);\n  }\n}"));
}, {
  info: {
