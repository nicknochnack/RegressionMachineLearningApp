...
describe('TimePicker', function () {
  describe('renders as expected', function () {
    describe('input', function () {
      ...
      var textInput;
      beforeEach(function () {
        wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_TimePicker.default, {
          id: "test",
  ...
  describe('events', function () {
    ...
    describe('enabled textinput', function () {
      ...
      var onChange = jest.fn();
      var onBlur = jest.fn();
      var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_TimePicker.default, {
        id: "test",
        onClick: onClick,
        onChange: onChange,
        onBlur: onBlur
  ...
  describe('Getting derived state from props', function () {
    var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_TimePicker.default, null));
