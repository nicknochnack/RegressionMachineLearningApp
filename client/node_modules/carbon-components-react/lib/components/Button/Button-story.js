...
var props = {
  ...
  iconOnly: function iconOnly() {
    ...
    return {
      className: 'some-class',
      kind: (0, _addonKnobs.select)('Button kind (kind)', {
        'Primary button (primary)': 'primary',
        'Secondary button (secondary)': 'secondary',
        'Tertiary button (tertiary)': 'tertiary',
        'Ghost button (ghost)': 'ghost'
...
(0, _react2.storiesOf)('Buttons', module).addDecorator(_addonKnobs.withKnobs).add('Default', function () {
  ...
  }, /*#__PURE__*/_react.default.createElement(_Button.default, _extends({}, regularProps, {
    className: "some-class"
  }), "Button"), "\xA0", /*#__PURE__*/_react.default.createElement(_Button.default, _extends({}, regularProps, {
    href: "#",
    className: "some-class"
  }), "Link"), "\xA0", /*#__PURE__*/_react.default.createElement(_Button.default, _extends({}, regularProps, {
    as: "p",
    href: "#",
    className: "some-class"
  }), "Element"), "\xA0", /*#__PURE__*/_react.default.createElement(_Button.default, _extends({}, regularProps, {
    as: CustomLink,
    href: "#",
    className: "some-class"
  }), "Custom component"));
  ...
  return /*#__PURE__*/_react.default.createElement(_Button.default, _extends({}, props.iconOnly(), {
    hasIconOnly: true
  }));
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    kind: "secondary"
  }, setProps), "Secondary button"), /*#__PURE__*/_react.default.createElement(_Button.default, _extends({
    kind: "primary"
