...
describe('ProgressIndicator', function () {
  describe('Renders as expected', function () {
    var progress = /*#__PURE__*/_react.default.createElement(_ProgressIndicator.ProgressIndicator, {
    ...
    it('should trigger onChange if clicked', function () {
      ...
      mountedList.find(_ProgressIndicator.ProgressStep).at(0).find('button').simulate('click');
...
describe('ProgressIndicatorSkeleton', function () {
  describe('Renders as expected', function () {
    var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_ProgressIndicator2.default, null));
