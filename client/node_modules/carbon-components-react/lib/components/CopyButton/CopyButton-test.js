...
describe('CopyButton', function () {
  ...
  describe('Renders button props as expected', function () {
    var wrapper;
    beforeEach(function () {
      wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_CopyButton.default, null));
    });
    it('Renders children as expected', function () {
      expect(wrapper.find('button').hasClass("".concat(prefix, "--copy-btn"))).toBe(true);
      expect(wrapper.find(".".concat(prefix, "--copy-btn__feedback")).length).toBe(1);
    ...
    it('Should have a default feedback timeout', function () {
      var timeoutWrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_CopyButton.default, null));
    ...
    it('Should be able to set the timeout for displaying feedback', function () {
      var timeoutWrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_CopyButton.default, {
    ...
    it('Should be able to specify the feedback message', function () {
      var feedbackWrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_CopyButton.default, {
        feedback: "Copied!"
      }));
  ...
  describe('Triggers appropriate events', function () {
    it('should call the click handler', function () {
      var onClick = jest.fn();
      var clickWrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_CopyButton.default, {
        onClick: onClick
      }));
