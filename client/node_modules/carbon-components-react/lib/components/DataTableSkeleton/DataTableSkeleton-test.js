...
describe('DataTableSkeleton', function () {
  describe('Renders as expected', function () {
    ...
    var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_DataTableSkeleton.default, {
      compact: true,
      rowCount: rowCount,
    ...
    it('Has the expected classes', function () {
      ...
      expect(wrapper.hasClass("".concat(prefix, "--data-table-container"))).toEqual(true);
    });
...
describe('DataTableSkeleton Compact', function () {
  describe('Renders as expected', function () {
    ...
    it('Has the expected classes', function () {
      expect(wrapper.hasClass("".concat(prefix, "--skeleton"))).toEqual(true);
      expect(wrapper.find(".".concat(prefix, "--data-table")).hasClass("".concat(prefix, "--data-table--compact"))).toEqual(true);
    });
  });
});
describe('DataTableSkeleton Zebra', function () {
  describe('Renders as expected', function () {
    ...
    it('Has the expected classes', function () {
      expect(wrapper.hasClass("".concat(prefix, "--skeleton"))).toEqual(true);
      expect(wrapper.find(".".concat(prefix, "--data-table")).hasClass("".concat(prefix, "--data-table--zebra"))).toEqual(true);
    });
  });
});