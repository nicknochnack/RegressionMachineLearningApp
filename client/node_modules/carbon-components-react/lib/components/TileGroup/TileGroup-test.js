...
describe('TileGroup', function () {
  describe('renders as expected', function () {
    var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_TileGroup.default, {
  ...
  describe('Getting derived state from props', function () {
    it('should change the selected item upon change in props', function () {
      var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_TileGroup.default, {
        name: "gender",
        valueSelected: "male"
      }, /*#__PURE__*/_react.default.createElement(_RadioTile.default, {
        labelText: "Male",
