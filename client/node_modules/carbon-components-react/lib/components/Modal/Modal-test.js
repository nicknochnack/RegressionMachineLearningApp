 ...
 */
var prefix = _carbonComponents.settings.prefix; // The modal is the 0th child inside the wrapper on account of focus-trap-react
...
describe('Modal', function () {
  describe('Renders as expected', function () {
    ...
    var mounted = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_Modal.default, {
      "aria-label": "test",
      className: "extra-class"
    }));
    ...
    it('should set id if one is passed via props', function () {
      var modal = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_Modal.default, {
        "aria-label": "test",
        id: "modal-1"
      }));
    ...
    it('should have iconDescription match Icon component description prop', function () {
      var description = mounted.find(_iconsReact.Close20).props()['aria-label'];
    ...
    it('Should have node in primary', function () {
      mounted.setProps({
        primaryButtonText: /*#__PURE__*/_react.default.createElement(_InlineLoading.default, null)
      });
      var primaryButton = mounted.find(".".concat(prefix, "--btn.").concat(prefix, "--btn--primary")).at(0);
    ...
    it('Should have node in secondary', function () {
      mounted.setProps({
        secondaryButtonText: /*#__PURE__*/_react.default.createElement(_InlineLoading.default, null)
      });
  ...
  describe('events', function () {
    ...
    it('should close by default on secondary button click', function () {
      var onRequestClose = jest.fn();
      var modal = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_Modal.default, {
        "aria-label": "test",
        onRequestClose: onRequestClose
      }));
